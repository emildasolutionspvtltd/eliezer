...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryColor = const Color(0xFF348AA7);
  late Color tertiaryColor = const Color(0xFF7B7B7B);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF2EFE4);
  late Color primaryText = const Color(0xFF3B3B3B);
  late Color secondaryText = const Color(0xFF57636C);

  late Color primaryBtnText = Color(0xFFFFFFFF);
  late Color lineColor = Color(0xFFD0B252);
}
